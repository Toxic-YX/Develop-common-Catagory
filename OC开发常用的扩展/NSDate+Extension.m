...
+ (NSString *)formatYMDWithChar:(NSDate *)date {
    return [NSString stringWithFormat:@"%lu年%02lu月%02lu日",(unsigned long)[date year],(unsigned long)[date month], (unsigned long)[date day]];
}
